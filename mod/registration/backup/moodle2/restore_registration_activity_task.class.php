...
require_once($CFG->dirroot . '/mod/registration/backup/moodle2/restore_registration_stepslib.php'); // Because it exists (must)

/**
 * registration restore task that provides all the settings and steps to perform one
 * complete restore of the activity
 */
class restore_registration_activity_task extends restore_activity_task {
	...
	$contents[] = new restore_decode_content('registration', array('intro'), 'registration');
     ...
     * registration logs. It must return one array
